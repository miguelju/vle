...
def build() -> nbf.NotebookNode:
    ...
    cells.append(md(
        ...
        "[Chapter IV — Validation](https://github.com/miguelju/vle/blob/main/docs/en/research-paper/chapter-4-validation.md) "
        ...
        "the systems studied [...].\"* — [§4.1](https://github.com/miguelju/vle/blob/main/docs/en/research-paper/chapter-4-validation.md#41-critical-point-calculations)\n"
        "\n"
        ...
        "the vapor phase [...].\"* — [§4.3 / Table 4.5](https://github.com/miguelju/vle/blob/main/docs/en/research-paper/chapter-4-validation.md#43-bubble-point-pressure)\n"
        "\n"
        ...
        "constant temperature used for solving the stated problem [...].\"* — [§4.7 / Table 4.11](https://github.com/miguelju/vle/blob/main/docs/en/research-paper/chapter-4-validation.md#47-binary-interaction-parameter-calculation)\n"
        "\n"
    ...
    cells.append(md(
        ...
        "in code:\n"
        "\n"
        "1. **SQL schema** ([`python/src/vle/db/sql/schema.sql`](https://github.com/miguelju/vle/blob/main/python/src/vle/db/sql/schema.sql)) "
        ...
        "4. **Chapter IV seed** ([`python/src/vle/db/sql/seed_chapter4.sql`](https://github.com/miguelju/vle/blob/main/python/src/vle/db/sql/seed_chapter4.sql)) "
    ...
    cells.append(md(
        "## References\n"
        "\n"
        "- **Research paper**: [Chapter IV — Validation](https://github.com/miguelju/vle/blob/main/docs/en/research-paper/chapter-4-validation.md), "
