...
def build() -> nbf.NotebookNode:
    ...
    cells.append(md(
        ...
        "in code:\n"
        "\n"
        "1. **SQL schema** ([`data/schema.sql`](../data/schema.sql)) — four "
        "   tables: `components`, `kij_params`, `activity_params`, "
        ...
        "4. **Chapter IV seed** ([`data/seed_chapter4.sql`](../data/seed_chapter4.sql)) — "
