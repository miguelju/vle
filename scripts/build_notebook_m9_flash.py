...
def build():
    ...
    c.append(md(
        ...
        "- Algorithm details: [`MODERNIZATION_PLAN.md`](https://github.com/miguelju/vle/blob/main/docs/plans/MODERNIZATION_PLAN.md) §F, §J, §M and `engine/src/flash/{isothermal,adiabatic}.rs`.\n"
    ))
